...
function Ejemplo({ titulo, desc, tarifa }: { titulo: string; desc: string; tarifa: string }) {
  return (
    <div className="mx-auto max-w-[760px] rounded-2xl border border-line bg-paper p-5">
      ...
      <p className="mt-3 text-[13px] leading-relaxed text-ink-3">
        Ejemplo de un documento ya legalizado (datos de ejemplo). El documento completo se muestra abajo.
      </p>
    </div>
  );
}
